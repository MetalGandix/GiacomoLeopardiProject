...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				.authorizeRequests().antMatchers("/authenticate","/mobilenumbers/{mobilenumber}/otp", "/register","/user","/visita","/existUser/{username}","/vediVisite","/cancellaVisita/{id}","/vediUtenti", "/visita", "/vediUtenti/{username}","/vediVisita/{id}", "/visiteCancellate", "/inserisciModulo", "/vediEventi","/getPoesia/{titolo}", "/getPoesie").permitAll()
